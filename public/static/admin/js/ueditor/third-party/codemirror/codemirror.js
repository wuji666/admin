...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        var instance = wrapper.CodeMirror = {
            ...
            indentLine: operation(function(n, dir) {
                if (isLine(n)) indentLine(n, dir == null ? "smart" : dir ? "admin.view.notice.add" : "subtract");
            }),
        ...
        function indentLine(n, how) {
            if (!how) how = "admin.view.notice.add";
            if (how == "smart") {
            ...
            else if (how == "admin.view.notice.add") indentation = curSpace + options.indentUnit;
    ...
    var commands = CodeMirror.commands = {
        ...
        indentMore: function(cm) {cm.indentSelection("admin.view.notice.add");},
